...
SYSTEM_PROMPT = (
    ...
    "finishing. After changing files, a successful command is required before "
    "completion. Repeated tool calls that produce the same result will be "
    "treated as no progress, so change approach when a tool is not helping. "
    f"Use this exact Python interpreter: {sys.executable}. Always "
